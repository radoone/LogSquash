...
LogSquash is a token-saving extension for Codex CLI. It compresses repetitive logs using a dictionary-based approach.

## Skills
- `logsquash`: The primary skill for compressing logs. Activate it by calling the skill.
